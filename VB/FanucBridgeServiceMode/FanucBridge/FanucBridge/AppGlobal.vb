...
Public Module AppGlobal
    ...
    ' PLC Setting for PID PLC
    Public Const SETTINGS_KEY_PLCIP = "PLCIPAddress"
    Public Const SETTINGS_KEY_PLCPORT = "PLCPort"

    ' Fanuc Adaptive Enable
    Public Const SETTINGS_KEY_ADAPTIVE_ENABLE_TYPE = "FanucAdaptiveEnableType"
    Public Const SETTINGS_KEY_ADAPTIVE_ADDRESS = "FanucAdaptiveEnableAddr"
