...
public class ShiftDataModel {
    ...
    // Extension later
    public static final String COLUMN_EXT1 = "ext1";    // Used for rework/setup status value  0: NONE, 1: REWORK, 2: SETUP
    ...
    public static final String CREATE_SHIFT_DATA_TABLE =
            "CREATE TABLE IF NOT EXISTS " + TABLE_SHIFT_DATA_NAME + "("
    ...
    private int shiftStartTime = 0; // Server Setting Start Time 08:00  = 8 * 60
    private int shiftStopTime = 0;  // Server Setting Stop Time 16:30 = 16 * 60 + 30
    ...
    private long startTime = 0;     // Shift Start Time
    private long stopTime = 0;      // Shift Stop Time
    ...
    * */
    ...
    public void calcRegime() {
        ...
        long secFromMidnight = stopTime - startTime;
        ...
        // Availability 1
        //long plannedProductionTimeInSec = PreferenceManager.getPlannedProductionTime();
        //availablity = elapsedMiliseconds[1] * 100.0f / plannedProductionTimeInSec;

        // Availability 2
        long passedTime = stopTime - DateTimeUtils.getTimeInMiliSecondsFromMidnight() - shiftStartSetting;
        ...
        if (!TextUtils.isEmpty(jobID)) {
            ...
            if (elapsedMiliseconds[1] > 0 || targetCycleTimeInSec > 0) {
                if (elapsedMiliseconds[1] == 0) {
                    ...
                    performance = targetCycleTimeInSec * totalParts * 100.0f / elapsedMiliseconds[1];
                }
