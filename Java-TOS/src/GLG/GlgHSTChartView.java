...
//////////////////////////////////////////////////////////////////////////
public class GlgHSTChartView extends JPanel {
    ...
    */
    ...
    public void showHSTData(HSTFileReadManager fileReadManager) {
        glg_bean.showHSTData(fileReadManager);
    ...
    public static void Main(final String arg[]) {
        ...
        GlgHSTChartView panel = new GlgHSTChartView();
