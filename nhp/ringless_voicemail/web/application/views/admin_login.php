                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="<?php echo base_url('assets/'); ?>images/logo.svg" alt="" height="28"> <span class="logo-txt">Farming Ringless Voicemail Admin</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Welcome Back !</h5>
                                        <p class="text-muted mt-2">Sign in to continue to Farming Ringless Voicemail Admin.</p>
                                    </div>
