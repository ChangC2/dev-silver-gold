    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row mt-3 mx-2 <?php echo $permission == 0 ? '' : 'd-none'; ?>">
          <div class="col-lg-12 col-md-12">
            <input type="text" class="form-control" id="voice_id" placeholder="Input Cloned Voice ID - Api Key" value="">
          </div>
        </div>
        ...
        <div class="row my-3">
          <div class="col-lg-12 col-md-12 text-center">
            <span class="text-danger" style="font-size: 12px;">*You are only allowed to clone your own voice. After recording your cloned voice will be reviewed and a technician will call to do a quick interview.</span>
          </div>
        </div>
