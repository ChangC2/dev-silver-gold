      ...
      <div class="modal-body">
        ...
        <div class="row mx-2 mt-3">
          <div class="col-lg-12 col-md-12">
            ...
            <select class="form-control" data-trigger name="salutation" id="salutation" placeholder="Select Salutation">
        ...
        <div class="row mt-3 mx-2">
          <div class="col-lg-12 col-md-12">
            ...
            <textarea id="content" class="form-control" rows="3" placeholder="Input Content..."></textarea>
          </div>
        </div>
      </div>
