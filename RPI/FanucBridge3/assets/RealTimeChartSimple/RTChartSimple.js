                 ...
                 /*String*/ path )
{
   ...
   if( "WebSocket" in window)
   {
      ...
      AppAlert( "Browser doesn't support realtime data!" );
      return;
   }
}
...
function StartGlgChart( /*GlgObject*/ drawing )
{
   ...
   var ws = new WebSocket("ws://" + host + ":5151");
   ws.onopen = function() {
