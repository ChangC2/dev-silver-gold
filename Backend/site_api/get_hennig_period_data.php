...
$sql = "SELECT  sensor_id, reading_time, value1, value2 FROM hennig_data WHERE `reading_time`>='$from_date' AND `reading_time` <= '$to_date' GROUP BY sensor_id, LEFT(`reading_time`, 13) ORDER BY reading_time";
