...
if ($customer_id != '' && $machine != '' && $data_points != '') {
    $query = "INSERT INTO `$tableName` (`customer_id`, `dashboard_id`, `widget_type`, `widget_size`, `data_points`, `machine`,`operator`,`jobID`,`days`)";
    $query .= " VALUES ('$customer_id','$dashboard_id','$widget_type','$widget_size', '$data_points', '$machine','$operator','$jobID','$days')";
