        ...
        RetrofitClient.getClient(ApiConstants.BASE_URL)
                ...
                .enqueue(new Callback<CommonRes>() {
                    ...
                    public void onFailure(Call<CommonRes> call, Throwable t) {
                        EventBus.getDefault().post(new SupplierListRes());
                    }
                });

    }
    public static void getVendorList(int offset, int page_size, String keyword) {
        RetrofitClient.getClient(ApiConstants.BASE_URL)
                .create(Supplier.class)
                .getVendorList(App.getToken(), App.getPortalToken(), offset, page_size, keyword)
                .enqueue(new Callback<CommonRes>() {
                    @Override
                    public void onResponse(Call<CommonRes> call, Response<CommonRes> result) {
                        SupplierListRes res = new SupplierListRes();
