...
public class AdsPayPromoteFragment extends BaseFragment {
    private View mFragView;

    public AdsPayPromoteFragment() {
    }

    public static AdsPayPromoteFragment newInstance() {
        AdsPayPromoteFragment fragment = new AdsPayPromoteFragment();
