...
public class HomeFragment extends BaseFragment {
    ...
    private void initData(DashboardInfoRes res) {
        ...
        payPromoteList.clear();
        payPromoteList.addAll(res.getPayPromoteList());
        ...
        txtPromotion.setText(String.valueOf(res.getPromotions()));
        txtPost.setText(String.valueOf(res.getPosts()));
        txtStore.setText(String.valueOf(res.getStores()));
        txtFollower.setText(String.valueOf(res.getFollows()));
    ...
    @OnClick({R.id.btnPromotionView, R.id.btnPostView, R.id.btnStoreView, R.id.btnFollowerView, R.id.txtStoreReviewAll})
