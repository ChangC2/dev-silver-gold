...
public class ChartProductFragment extends BaseFragment {
    ...
    public ChartProductFragment() {
    }

    public static ChartProductFragment newInstance() {
        ChartProductFragment fragment = new ChartProductFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mFragView = inflater.inflate(R.layout.fragment_chart_product, container, false);
...
//        xAxis.setValueFormatter(new MyAxisValueFormatter(xEntrys));
    ...
    private void getBarEntries() {
        ...
        barEntriesArrayList.add(new BarEntry(2, 2));
        barEntriesArrayList.add(new BarEntry(3, 3));
        barEntriesArrayList.add(new BarEntry(4, 2));
        barEntriesArrayList.add(new BarEntry(5, 4));
        barEntriesArrayList.add(new BarEntry(6, 7));
    }
