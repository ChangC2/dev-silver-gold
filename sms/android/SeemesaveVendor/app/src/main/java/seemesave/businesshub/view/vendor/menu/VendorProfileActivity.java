...
public class VendorProfileActivity extends BaseActivity {
    ...
    private VendorProfileActivity activity;
    ...
    @BindView(R.id.editBAddress)
    TextInputEditText edtBusinessAddress;
    @BindView(R.id.editBEmail)
    TextInputEditText edtBusinessEmail;
    @BindView(R.id.editLink)
    TextInputEditText edtBusinessWebsite;
    @BindView(R.id.editPhone)
    TextInputEditText edtBusinessNumber;
    ...
    private void initData(PortalProfileInfoRes res) {
        Glide.with(activity)
                ...
                .into(imgProfile);
        edtBusinessName.setText(res.getData().getName());
//        edtBusinessAddress.setText(res.get);
        edtBusinessEmail.setText(res.getData().getEmail());
        edtBusinessNumber.setText(res.getData().getPhone());
        edtBusinessWebsite.setText(res.getData().getWebsite());
    ...
    private void onUpdate() {
        ...
        String address = edtBusinessAddress.getText().toString();
        String email = edtBusinessEmail.getText().toString();
        String website = edtBusinessWebsite.getText().toString();
        String number = edtBusinessNumber.getText().toString();
        ...
        Builders.Any.B builder = Ion.with(activity)
                .load("PUT", G.UpdatePortalProfile);
