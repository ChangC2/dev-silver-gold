...
public class MainActivity extends BaseActivity {
    ...
    public Fragment homeFragment, orderFragment, analyticsFragment, adsFragment, menuFragment;
    ...
    public void setTab(int index) {
        ...
        if (checkExist(G.tabName[index])) {
            ...
            switch (index) {
                case 1:
                    newFragment = OrderFragment.newInstance();
                    break;
                case 2:
    ...
    public void setBottomBarStyle(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                txtTitle.setText(R.string.orders);
                break;
            case 2:
