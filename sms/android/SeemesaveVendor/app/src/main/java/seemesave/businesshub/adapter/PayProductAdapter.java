...
public class PayProductAdapter extends RecyclerView.Adapter<PayProductAdapter.ViewHolder>{
    ...
    public PayProductAdapter(Context context, ArrayList<PayPromoteModel> list, PayProductRecyclerListener listener){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.rv_pay_product, parent, false);
