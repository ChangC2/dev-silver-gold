...
public class PromoteCommentActivity extends BaseActivity {
    ...
    PromoteCommentActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_promote_comment);
        ButterKnife.bind(this);
        activity = this;
        promote_id = getIntent().getStringExtra("id");
        initUI();
    }
    ...
    private void setRecycler() {
        ...
        RecyclerClickListener listener = new RecyclerClickListener() {
            ...
            public void onClick(View v, int position) {
                Intent intent = new Intent(activity, PromoteCommentReplyActivity.class);
                Gson gson = new Gson();
    ...
    void apiCallForGetComments() {
        ...
        String url = String.format(java.util.Locale.US, G.GetPromoteReviews, promote_id, offset, limit);
        showLoadingDialog();
        Ion.with(activity)
                .load(url)
...
//                                                reply.setCreated(replyArry.getJSONObject(j).getString("created"));
    ...
    void apiCallForSendComment(String comment_str){
        ...
        String rname = String.format(java.util.Locale.US,"%s %s", App.getUserFirstName(),
                App.getUserLastName());
        item.setName(rname);
        item.setImageUrl(App.getUserImage());
        ...
        json.addProperty("id", promote_id);
        json.addProperty("comment", editComment.getText().toString().trim());
        showLoadingDialog();
        Ion.with(activity)
                .load("POST", G.SetPromoteReviewUrl)
                .addHeader("Authorization", App.getToken())
                .addHeader("Content-Language", App.getPortalToken())
