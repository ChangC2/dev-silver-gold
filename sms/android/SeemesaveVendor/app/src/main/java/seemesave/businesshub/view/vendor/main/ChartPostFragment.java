...
public class ChartPostFragment extends BaseFragment {
    ...
    public ChartPostFragment() {
    }

    public static ChartPostFragment newInstance() {
        ChartPostFragment fragment = new ChartPostFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mFragView = inflater.inflate(R.layout.fragment_chart_post, container, false);
...
//        xAxis.setValueFormatter(new MyAxisValueFormatter(xEntrys));
    ...
    private void getBarEntries() {
        ...
        barEntriesArrayList.add(new BarEntry(1, 1));
