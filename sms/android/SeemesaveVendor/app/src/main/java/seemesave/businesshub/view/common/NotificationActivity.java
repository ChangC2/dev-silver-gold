...
import seemesave.businesshub.adapter.NotificationAdapter;
...
import seemesave.businesshub.view_model.vendor.menu.NotificationViewModel;
...
public class NotificationActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        setRecycler();
        try {
            String local_data = DatabaseQueryClass.getInstance().getData(App.getUserID(), "Notification", "");
