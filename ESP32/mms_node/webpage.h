  ...
  <html>
    ...
    <body>
      <div class="container">
        ...
        <div class="sub-container">
          <div class="sub-title">Network Type</div>
          <select name="networktype" id="networktype" class="settings-input">
            <option value="mesh" style="color:black;">Slytek IoT Mesh Network</option>
            <option value="ethernet" style="color:black;">Ethernet</option>
          </select>
          <button onclick="setNetworkType()" class="settings-button">Save</button>
        </div>
      </div>
    </body>
  </html>
...
const char SCRIPT[] PROGMEM = R"=====(
  ...
  const apiSetNetworkType = "/setNetworkType";
  ...
  function getMachine() {
    this.request(apiGetMachine, "get", {}, (response) => {
      ...
      if (response) {
        ...
        document.getElementById("networktype").value = response.networktype;
      }
    });
  }
  ...
  function setNetworkType() {
    ...
    this.request(apiSetNetworkType, "post", data, (response) => {});
  }
