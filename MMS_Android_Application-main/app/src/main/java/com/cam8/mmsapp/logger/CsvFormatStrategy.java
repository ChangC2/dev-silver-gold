...
public class CsvFormatStrategy implements FormatStrategy {
    ...
    public static final class Builder {
        private static final int MAX_BYTES = 888 * 1024; // 500K averages to a 4000 lines per file
        ...
        @NonNull
        public Builder logFilePrefix(@NonNull String namePrefix) {
        ...
        public CsvFormatStrategy build() {
            if (TextUtils.isEmpty(logFilePrefix)) {
                ...
                logFilePrefix = String.format("Log(%s)", currentTimeString);
            }
            ...
            if (logStrategy == null) {
                ...
                String folder = diskPath + File.separatorChar + "MMSLogs";

                HandlerThread ht = new HandlerThread("AndroidFileLogger." + folder);
                ht.start();
                Handler handler = new DiskLogStrategy.WriteHandler(ht.getLooper(), folder, MAX_BYTES, logFilePrefix);
