...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void takeCameraImage() {
        ...
        if (checkPermissions(ImagePickerActivity.this, PERMISSION_REQUEST_CAMERA_STRING, false, PERMISSION_REQUEST_CODE_CAMERA)) {
            getCameraImage();
        }
    }
    ...
    private void chooseImageFromGallery() {
        if (checkPermissions(ImagePickerActivity.this, PERMISSION_REQUEST_GALLERY_STRING, false, PERMISSION_REQUEST_CODE_GALLERY)) {
            getGalleryImage();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (bAllGranted) {
            ...
            Toast.makeText(this, "Need permissions to use function.", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
