...
public class AssemblyStation3Fragment extends BaseFragment implements View.OnClickListener {
    ...
    // Assembly Usage1
    View layoutUsage1;
    TextView tvmil_d_16791_non_ionic_detergent_lot;
    TextView tv923as829_drive_lok_pins_lot;
    TextView tvams_s_8802_polysulfide_lot;

    TextView tv4512421_base_plate_lt;
    TextView tv4512422_abs_insert_lot;
    TextView tv4512423_steel_insert_lot;

    RadioButton radioInputBarcode;
    EditText edtActiveArea;

    public static AssemblyStation3Fragment newInstance(String text) {
        AssemblyStation3Fragment mFragment = new AssemblyStation3Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_assemblystation3, container, false);
    ...
    private void initLayout(View parentView) {
        ...
        tvmil_d_16791_non_ionic_detergent_lot = parentView.findViewById(R.id.tvmil_d_16791_non_ionic_detergent_lot);
        tv923as829_drive_lok_pins_lot = parentView.findViewById(R.id.tv923as829_drive_lok_pins_lot);
        tvams_s_8802_polysulfide_lot = parentView.findViewById(R.id.tvams_s_8802_polysulfide_lot);

        tv4512421_base_plate_lt = parentView.findViewById(R.id.tv4512421_base_plate_lt);
        tv4512422_abs_insert_lot = parentView.findViewById(R.id.tv4512422_abs_insert_lot);
        tv4512423_steel_insert_lot = parentView.findViewById(R.id.tv4512423_steel_insert_lot);
        ...
        tvmil_d_16791_non_ionic_detergent_lot.setOnTouchListener(touchListener);
        tv923as829_drive_lok_pins_lot.setOnTouchListener(touchListener);
        tvams_s_8802_polysulfide_lot.setOnTouchListener(touchListener);

        tv4512421_base_plate_lt.setOnTouchListener(touchListener);
        tv4512422_abs_insert_lot.setOnTouchListener(touchListener);
        tv4512423_steel_insert_lot.setOnTouchListener(touchListener);
    }
    ...
    private void getPartInfo() {
        ...
        ITSRestClient.post(mContext, "getAssembly3Station", requestParams, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                Log.e("assembly3ProcTime", response.toString());
                ...
                try {
                    if (response.has("status") && response.getBoolean("status")) {
                        ...
                        // Usage 1
                        tvmil_d_16791_non_ionic_detergent_lot.setText(jsonStation.optString("mil_d_16791_non_ionic_detergent_lot"));
                        tv923as829_drive_lok_pins_lot.setText(jsonStation.optString("923as829_drive_lok_pins_lot"));
                        tvams_s_8802_polysulfide_lot.setText(jsonStation.optString("ams_s_8802_polysulfide_lot"));

                        tv4512421_base_plate_lt.setText(jsonStation.optString("4512421_base_plate_lt"));
                        tv4512422_abs_insert_lot.setText(jsonStation.optString("4512422_abs_insert_lot"));
                        tv4512423_steel_insert_lot.setText(jsonStation.optString("4512423_steel_insert_lot"));
    ...
    private void reportTime() {
        ...
        if (isTimeCounting && elapsedSeconds > 0) {
            ...
            // Usage 1
            requestParams.put("mil_d_16791_non_ionic_detergent_lot", tvmil_d_16791_non_ionic_detergent_lot.getText().toString().trim());
            requestParams.put("923as829_drive_lok_pins_lot", tv923as829_drive_lok_pins_lot.getText().toString().trim());
            requestParams.put("ams_s_8802_polysulfide_lot", tvams_s_8802_polysulfide_lot.getText().toString().trim());

            requestParams.put("4512421_base_plate_lt", tv4512421_base_plate_lt.getText().toString().trim());
            requestParams.put("4512422_abs_insert_lot", tv4512422_abs_insert_lot.getText().toString().trim());
            requestParams.put("4512423_steel_insert_lot", tv4512423_steel_insert_lot.getText().toString().trim());

            GoogleCertProvider.install(mContext);
            ITSRestClient.post(mContext, "postAssembly3Station", requestParams, new JsonHttpResponseHandler() {
                @Override
                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                    super.onSuccess(statusCode, headers, response);
