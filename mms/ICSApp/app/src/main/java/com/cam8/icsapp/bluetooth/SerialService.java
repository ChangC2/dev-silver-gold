package com.cam8.icsapp.bluetooth;
...
public class SerialService extends Service implements SerialListener {
    ...
    private void createNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel nc = new NotificationChannel(Constants.NOTIFICATION_CHANNEL, "ICE Bluetooth Service", NotificationManager.IMPORTANCE_LOW);
